...
export class StaticBuilder extends BaseBuilder {
     ...
     */
    public constructor(pTemplates: Array<BaseXmlNode>, pAttributeModules: ComponentModules, pParentComponentValues: ComponentValues, pComponentHandler: ComponentHandler, pManipulatorScope: boolean) {
