...
export class ContentManager {
    ...
    private cleanElement(pElement: HtmlContent): void {
        ...
        if ('componentHandler' in pElement) {
            pElement.componentHandler.deconstruct();
        }
    ...
    private parseNodeToSloted(pParentElement: PwbComponentElement, pNode: Node, pTemplate: BaseXmlNode): Node {
        ...
        const lSlotName: string = pParentElement.componentHandler.getElementsSlotname(pTemplate);
