...
import { IPwbExpressionModuleClass, IPwbModuleClass, IPwbMultiplicatorModuleClass, IPwbStaticModuleClass } from '../interface/module';
import { ModuleDefinition } from './base/base-module';
