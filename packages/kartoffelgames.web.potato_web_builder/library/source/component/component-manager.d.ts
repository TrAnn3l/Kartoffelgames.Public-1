...
export declare class ComponentManager {
    private static readonly mTemplateStore;
    private static readonly mModuleStore;
    ...
    private mTemplate;
    private mUserClassConstructor;
    private mModules;
    private mUpdateHandler;
    /**
     ...
     */
    constructor(pUserClassConstructor: UserClassConstructor, pTemplate: string, pExpressionModule: PwbExpressionModuleConstructor, pHtmlComponent: HTMLElement, pUpdateScope: UpdateScope);
    /**
