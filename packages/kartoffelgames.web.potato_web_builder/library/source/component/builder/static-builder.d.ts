...
export declare class StaticBuilder extends BaseBuilder {
     ...
     */
    constructor(pTemplates: Array<BaseXmlNode>, pAttributeModules: ComponentModules, pParentComponentValues: LayerValues, pComponentHandler: ComponentManager, pManipulatorScope: boolean);
    /**
     * Initialize build.
