...
export declare class StaticBuilder extends BaseBuilder {
     ...
     */
    constructor(pTemplates: Array<BaseXmlNode>, pAttributeModules: ComponentModules, pParentComponentValues: ComponentValues, pComponentHandler: ComponentManager, pManipulatorScope: boolean);
    /**
     * Initialize build.
