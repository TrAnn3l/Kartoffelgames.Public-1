...
export declare abstract class BaseBuilder {
     ...
     */
    constructor(pTemplate: Array<BaseXmlNode>, pAttributeModules: ComponentModules, pComponentValues: ComponentValues, pComponentHandler: ComponentManager, pManipulatorScope: boolean);
    /**
