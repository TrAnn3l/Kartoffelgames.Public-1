...
export declare class ComponentModules {
     ...
     */
    getExpressionModule(pTargetNode: HtmlContent | Text, pAttributeName: string | null, pValue: string, pValueHandler: ComponentValues, pComponentHandler: ComponentHandler): IPwbExpressionModule;
    /**
     ...
     * @param pComponentHandler - Component handler.
     */
    getManipulatorModule(pTargetTemplate: XmlElement, pValues: ComponentValues, pComponentHandler: ComponentHandler): IPwbManipulatorAttributeModule | undefined;
    /**
     ...
     */
    getStaticModule(pTargetElement: HtmlContent, pTargetTemplate: XmlElement, pValues: ComponentValues, pAttribute: XmlAttribute, pComponentHandler: ComponentHandler, pAccessFilter?: AttributeModuleAccessType): IPwbStaticAttributeModule | undefined;
}
