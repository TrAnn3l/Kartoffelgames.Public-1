...
exports.LoopError = exports.ComponentHandler = void 0;
...
class ComponentHandler {
     ...
     */
    constructor(pUserClass, pTemplate, pAttributeModules, pHtmlComponent, pUpdateMode) {
        // Create new change detection if component is not inside change detection or mode is capsuled.
        if (!web_change_detection_1.ChangeDetection.current || pUpdateMode === update_mode_1.UpdateMode.Capsuled) {
            this.mChangeDetection = new web_change_detection_1.ChangeDetection('DefaultComponentZone');
        }
        else if (pUpdateMode === update_mode_1.UpdateMode.Manual) {
        ...
        if (pUpdateMode === update_mode_1.UpdateMode.Manual) {
        ...
        if (pUpdateMode === update_mode_1.UpdateMode.Manual) {
            ...
            lUserClassObject = core_dependency_injection_1.Injection.createObject(pUserClass, lLocalInjections);
        }
        else {
        ...
        this.mRootBuilder = new static_builder_1.StaticBuilder(pTemplate, pAttributeModules, lComponentValues, this, false);
