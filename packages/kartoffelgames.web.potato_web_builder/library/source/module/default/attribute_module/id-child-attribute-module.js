...
let IdChildAttributeModule = class IdChildAttributeModule {
     ...
     */
    onProcess() {
        const lRegistedElement = this.mComponentHandler.updateHandler.registerObject(this.mTargetElement);
...
IdChildAttributeModule = __decorate([
    ...
    __metadata("design:paramtypes", [Element, layer_values_1.LayerValues, core_xml_1.XmlAttribute, component_manager_1.ComponentManager])
