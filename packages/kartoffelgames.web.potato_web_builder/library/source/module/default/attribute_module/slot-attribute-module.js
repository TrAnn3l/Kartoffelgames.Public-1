...
let SlotAttributeModule = class SlotAttributeModule {
     ...
     */
    constructor(pComponentManager, pTargetTemplate, pValueHandler, pAttribute) {
...
SlotAttributeModule = __decorate([
    ...
    __metadata("design:paramtypes", [component_manager_1.ComponentManager, core_xml_1.XmlElement, layer_values_1.LayerValues, core_xml_1.XmlAttribute])
], SlotAttributeModule);
