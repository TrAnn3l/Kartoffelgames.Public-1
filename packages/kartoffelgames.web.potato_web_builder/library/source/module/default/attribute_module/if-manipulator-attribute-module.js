...
let IfManipulatorAttributeModule = class IfManipulatorAttributeModule {
    ...
    onProcess() {
        ...
        if (lExecutionResult) {
            lModuleResult.addElement(this.mTargetTemplate.clone(), new layer_values_1.LayerValues(this.mValueHandler));
        }
...
IfManipulatorAttributeModule = __decorate([
    ...
    __metadata("design:paramtypes", [core_xml_1.XmlElement, layer_values_1.LayerValues, core_xml_1.XmlAttribute])
