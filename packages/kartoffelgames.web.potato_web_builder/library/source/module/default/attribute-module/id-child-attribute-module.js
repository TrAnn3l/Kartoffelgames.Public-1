...
let IdChildAttributeModule = class IdChildAttributeModule {
     ...
     */
    constructor(pTargetElement, pValueHandler, pAttribute, pComponentManager) {
     ...
     */
    onProcess() {
        const lRegistedElement = this.mComponentManager.changeDetection.registerObject(this.mTargetElement);
