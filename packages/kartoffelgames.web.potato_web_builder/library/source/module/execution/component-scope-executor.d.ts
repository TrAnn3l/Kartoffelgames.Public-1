...
export declare class ComponentScopeExecutor {
     ...
     */
    static execute(pExpression: string, pValues: LayerValues, pExtenedData?: Dictionary<string, any>): any;
    /**
     * Execute string in userclass context.
     ...
     * @param pExtenedData - Extended data that are only exist for this execution.
     */
    static executeSilent(pExpression: string, pValues: LayerValues, pExtenedData?: Dictionary<string, any>): any;
    /**
